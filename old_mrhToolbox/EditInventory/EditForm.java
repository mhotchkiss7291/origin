  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    PrintWriter out = res.getWriter();
	  ...
	  if( dbc.getConnection()	== null ) {
		...
		out.println("<a href= \"./CreateTableForm\"> Create a New Table </a>");
		out.println("<p>");
		out.println("<a href= \"./UpdateForm\"> Edit a Table </a>");
		out.println("<p>");
		out.println("<a href= \"./DeleteTable\"> Delete a Table </a>");
		...
		out.println("<P>");
		out.println("<h3>Select Table:</h3>");
		out.println("<FORM METHOD=POST ACTION=\"/servlet/Query\">");
