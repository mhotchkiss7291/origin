...
public class ReturnIcabadServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.println("<center>");
    out.println("<h1>");
    out.println("Edit Icabad Services");
    out.println("</h1>");
    ...
    UserID = req.getParameter("userid");
		...
		out.println("<P>");
		out.println("<FONT FACE=\"helvetica, lucida sans\"><A HREF=\"/BCA/EditIcabadServices\">Return to Edit Icabad Services</A></FONT>");
		out.println("<P>");
		...
		out.println("<FORM METHOD=POST ACTION=\"/BCA/ResultIcabadServices\">");

		out.println("<P>");
		out.println("<P>");
		out.println("<b>Icabad Service</b> ");
		out.println("<SELECT NAME=icabad size=1>");
