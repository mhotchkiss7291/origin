...
public class RCEnableTokenCard extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.println("<p>");
		...
		out.println("Enabling a user's token card for them is subject to strict guidelines ");
    ...
    out.println(
			...
			"<FORM ACTION=\"/BCA/RCConfirmEnable\" METHOD=\"POST\" NAME=\"userid_form\">");
    out.println(
