...
public class ResultNSGServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    NsgSun = req.getParameter("alisun");
    ...
    Vector replyVector = new Vector();
		...
		if( !NsgSun.equals("-Select-") ) {
			sse.setNsgSun( NsgSun );
		}
		...
		out.println("<center>");
		out.println("<h1>Results: NSG Services</h1>");
		out.println("<p>");
		...
		if ( (sse.getReplyType()).equals("SERVICESRETURNED") ) {
			...
			out.println("<P>");
			out.println("<FONT FACE=\"helvetica, lucida sans\"><A HREF=\"/BCA/EditNSGServices\">Return to Edit NSG Services</A></FONT>");
			out.println("<P>");
