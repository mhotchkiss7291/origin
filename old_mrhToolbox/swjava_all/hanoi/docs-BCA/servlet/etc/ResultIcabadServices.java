...
public class ResultIcabadServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    Icabad = req.getParameter("icabad");
    ...
    Vector replyVector = new Vector();
		...
		if( !Icabad.equals("-Select-") ) {
			sse.setIcabad( Icabad );
		}
		...
		out.println("<center>");
		out.println("<h1>Results: Icabad Services</h1>");
		out.println("<p>");
