...
public class ReturnECCPXServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.println("<center>");
    out.println("<h1>");
    out.println("Edit ECCPX Services");
    out.println("</h1>");
    UserID = req.getParameter("userid");
		...
		out.println("<FORM METHOD=POST ACTION=\"/BCA/ResultECCPXServices\">");

		out.println("<P>");
		out.println("<P>");
		out.println("<b>ECCPX Service</b> ");
		out.println("<SELECT NAME=eccpx size=1>");
