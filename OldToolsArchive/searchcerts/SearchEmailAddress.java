...
public class SearchEmailAddress {
   ...
   public String doSearch( String search_input ) {
      ...
      String search_prefix = p.getProperty("searchcerts.email.search_prefix");
      String url = p.getProperty("searchcerts.email.url");
      String base = p.getProperty("searchcerts.email.base");
      String filter1 = p.getProperty("searchcerts.email.filter1");
         ...
         while (sEnum.hasMore()) {
            ...
            for (NamingEnumeration ae = attrs.getAll();
              ...
              if( ((String)attr.getID()).equals( filter1 )) {
								email_address = attr.get().toString();
              }
           }
           ++count;
				}
