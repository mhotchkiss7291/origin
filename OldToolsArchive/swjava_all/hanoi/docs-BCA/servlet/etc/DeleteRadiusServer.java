...
public class DeleteRadiusServer extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.println("<center>");
    out.println("<h1>");
    out.println("Delete Radius Server");
    out.println("</h1>");
    ...
    out.println(
			"<FORM ACTION=\"/BCA/RadiusDeleteConfirm\" METHOD=\"POST\" NAME=\"userid_form\">");
    out.println(
      "Enter the IP Address of the Radius server to be deleted <INPUT TYPE=TEXT NAME=\"ipaddress\">");
    out.println("<P>");
