...
public class ReturnITEServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    UserID = req.getParameter("userid");
		...
		out.println("<FORM METHOD=POST ACTION=\"/BCA/ResultITEServices\">");

		out.println("<P>");
		out.println("<P>");
		out.println("<b>ITE Service</b> ");
		out.println("<SELECT NAME=ite size=1>");
