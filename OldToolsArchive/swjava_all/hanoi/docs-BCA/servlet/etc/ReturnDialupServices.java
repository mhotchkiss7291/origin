...
public class ReturnDialupServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.println("<center>");
    out.println("<h1>");
    out.println("Edit Dialup Services");
    out.println("</h1>");
    ...
    UserID = req.getParameter("userid");
		...
		out.println("<FORM METHOD=POST ACTION=\"/BCA/ResultDialupServices\">");

		out.println("<P>");
		out.println("<P>");
		out.println("<b>Dialup Service</b> ");
		out.println("<SELECT NAME=dialup size=1>");
