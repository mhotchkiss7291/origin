...
public class ReturnPSCServices extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    UserID = req.getParameter("userid");
		...
		out.println("<FORM METHOD=POST ACTION=\"/BCA/ResultPSCServices\">");

		out.println("<P>");
		out.println("<P>");
		out.println("<b>PSC Service</b> ");
		out.println("<SELECT NAME=psc size=1>");
