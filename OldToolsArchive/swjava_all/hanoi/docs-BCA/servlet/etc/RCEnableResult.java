...
public class RCEnableResult extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    replyVector = new Vector();
      ...
      return;
		...
		RequestType = new String("RCENABLE");
...
/***End of repeat call to ironwood ***/
    ...
    if ( s.equals("ENABLECONFIRMED") ) {
			...
			if (s2.equals("ENABLECONFIRMED")) {
				...
				out.println("The user's token card has been successfully enabled.");
				out.println("<P>");
				...
				requestVector.setElementAt("RCENABLE", 5);
    ...
    out.println("<p>");
    out.println(
			"<a href=\"/BCA/RCEnableTokenCard\">Return to Enable User's Token Card.</a href>");
    out.println("<p>");
    out.println(
